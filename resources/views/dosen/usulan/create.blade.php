...
<div>
    ...
    <div id="anggotas-container" class="mt-4 space-y-3">
        ...
        <div class="anggota-row grid grid-cols-1 md:grid-cols-12 gap-4 items-start bg-gray-50 p-4 rounded-lg border border-gray-200" data-index="0">
    ...
    $('#tambah-anggota').click(function() {
        let html = `
            <div class="anggota-row grid grid-cols-1 md:grid-cols-12 gap-4 items-start bg-gray-50 p-4 rounded-lg border border-gray-200">
                ...
                <div class="md:col-span-2">
                <label for="anggota-peran-${anggotaIndex}" class="block text-xs font-medium text-gray-500 mb-1 md:hidden">Peran</label>
                <input type="text" id="anggota-peran-${anggotaIndex}" name="anggota[${anggotaIndex}][peran]" placeholder="Contoh: Anggota Peneliti" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" required>
            </div>
                <div class="md:col-span-1 flex justify-end md:justify-center items-center pt-1">
                    <button type="button" class="remove-anggota text-red-500 hover:text-red-700 bg-red-50 hover:bg-red-100 p-2 rounded-full transition">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg>
