...
<aside class="w-64 bg-white shadow-md flex flex-col h-screen fixed top-0" x-data="{ openPenelitian: false, openPengumuman: false }">
    ...
    <nav class="flex-1 mt-4 space-y-1 px-2">
        <!-- Dashboard -->
        <a href="{{ route('reviewer.dashboard') }}" class="block py-3 px-4 text-gray-700 hover:bg-gray-200 rounded flex items-center gap-3">
            <!-- Icon Dashboard -->
    ...
    <!-- Pengumuman program -->
        ...
        <div x-show="openPenelitian" x-cloak class="pl-8 space-y-1">
            <a href="" class="block py-2 px-4 text-gray-600 hover:bg-gray-200 rounded">Daftar Usulan</a>
