...
<head>
    ...
    <title>Edit Kategori - Admin P3M</title>
    ...
    <div class="flex-1 flex flex-col ml-64">
        ...
        <main class="flex-1 p-6">
            ...
            <div class="bg-white shadow rounded-lg p-6">
                {{-- Form action menunjuk ke route update dengan ID kategori --}}
                <form action="{{ route('admin.kategori-pengumuman.update', $kategoriPengumuman->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_kategori" id="nama_kategori" value="{{ $kategoriPengumuman->nama_kategori }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Masukkan Nama Kategori">
                    </div>
