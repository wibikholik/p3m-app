...
@section('content')
    ...
    <div class="flex justify-between items-center mb-8">
        <h2 class="text-3xl font-extrabold text-gray-900">Edit Pengumuman</h2>
        ...
        <form action="{{ route('admin.pengumuman.update', $pengumuman->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-5">
                ...
                <textarea name="isi" id="isi" rows="10" 
                          ...
                          class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 py-2 px-3 text-gray-800 transition duration-150" required>{{ old('isi', $pengumuman->isi) }}</textarea>
            </div>
            ...
            {{-- Upload Gambar --}}
            <div class="mb-6">
                <label for="gambar" class="block text-sm font-medium text-gray-700 mb-2">Gambar Saat Ini (Opsional):</label>
                @if ($pengumuman->gambar)
                    <div class="flex items-center space-x-4 mb-2">
                        <img src="{{ asset('storage/' . $pengumuman->gambar) }}" 
                             alt="Gambar Pengumuman Saat Ini" 
                             class="h-24 w-auto object-cover rounded-lg shadow-md border border-gray-200">
                        <span class="text-sm text-gray-600">File saat ini akan diganti jika Anda mengunggah file baru.</span>
                    </div>
                @else
                    <span class="text-sm text-gray-500 block mb-2 italic">Tidak ada gambar terunggah saat ini.</span>
                @endif
                
                <div class="mt-3 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:bg-gray-50 transition">
                    <div class="space-y-1 text-center">
                        ...
                        <div class="flex text-sm text-gray-600 justify-center">
                            ...
                            <p class="pl-1">untuk mengganti gambar</p>
                        </div>
